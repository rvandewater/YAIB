...
def build_parser() -> ArgumentParser:
    ...
    parser.add_argument("--load_data_vars", default=False, action=BOA,
                        help="Load data variables from the dataset directory. Avoids having to manually add "
                             "the path in the task.gin")
    return parser
